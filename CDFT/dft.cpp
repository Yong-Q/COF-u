...
if(fft_for!=NULL)  fftw_destroy_plan(fft_for);
if(fft_bak!=NULL)  fftw_destroy_plan(fft_bak);
if(fft_n0_for!=NULL)  fftw_destroy_plan(fft_n0_for);
if(fft_n3_for!=NULL) fftw_destroy_plan(fft_n3_for);
if(fft_nv2x_for!=NULL)  fftw_destroy_plan(fft_nv2x_for);
if(fft_nv2y_for!=NULL)  fftw_destroy_plan(fft_nv2y_for);
if(fft_nv2z_for!=NULL)  fftw_destroy_plan(fft_nv2z_for);
if(fft_cor_for!=NULL)  fftw_destroy_plan(fft_cor_for);
if(fft_n0_bak!=NULL)  fftw_destroy_plan(fft_n0_bak);
if(fft_n3_bak!=NULL)  fftw_destroy_plan(fft_n3_bak);
if(fft_nv2x_bak!=NULL)  fftw_destroy_plan(fft_nv2x_bak);
if(fft_nv2y_bak!=NULL)  fftw_destroy_plan(fft_nv2y_bak);
if(fft_nv2z_bak!=NULL)  fftw_destroy_plan(fft_nv2z_bak);
if(fft_cor_bak!=NULL)  fftw_destroy_plan(fft_cor_bak);
